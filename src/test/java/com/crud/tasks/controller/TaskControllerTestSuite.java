...
public class TaskControllerTestSuite {
    ...
    public void shouldGetTask() throws Exception {
        ...
        when(dbService.getTaskById(1L)).thenReturn(taskOptional);
    ...
    public void shouldTaskNotFoundException() throws Exception {
        ...
        //when & then
        mockMvc.perform(get("/v1/tasks/getTask?taskId=1").contentType(MediaType.APPLICATION_JSON))
    ...
    public void deleteTask() throws Exception {
        //when & then
        mockMvc.perform(delete("/v1/tasks/deleteTask?taskId=1").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
